  ...
  return (
    <section className="relative w-full min-h-[calc(100vh-84px)] bg-[#FAF8F5] text-[#2D2926] overflow-hidden border-b border-[#E8E1D5] flex flex-col justify-between">
      ...
      <div className="w-full border-b border-[#E8E1D5] bg-[#FAF8F5]">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 py-2.5 sm:py-3 flex items-center justify-between text-[9.5px] sm:text-[10.5px] font-semibold tracking-[0.24em] text-[#78716A] uppercase font-dm">
          <span>ADVOCACY FOR A STRONGER TOMORROW</span>
          <span>LAW &nbsp;|&nbsp; STRATEGY &nbsp;|&nbsp; JUSTICE</span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-0 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between pr-0 lg:pr-6 xl:pr-10 z-10">
            <div>
              ...
              {/* Main Headline (Original Large Font Size Restored, strictly 2 lines) */}
              <h1 className="font-heading text-3xl sm:text-5xl lg:text-[50px] xl:text-[56px] font-bold tracking-tight text-[#1A1817] leading-[1.08]">
                <span className="block whitespace-nowrap">Built on Principle.</span>
                <span className="block gold-gradient-shine whitespace-nowrap mt-1 sm:mt-2">Driven by Purpose.</span>
              </h1>

              {/* Chamber Overview Paragraph (DM Sans Subheading) */}
              <p className="mt-4 sm:mt-5 text-[#554E46] text-sm sm:text-[15px] leading-relaxed max-w-[430px] font-dm font-normal">
          ...
          {/* ================= CENTER COLUMN: Motto with matched-height vertical line (No overlap, exact text height) ================= */}
          ...
          <div className="lg:col-span-6 relative flex flex-col justify-center">
            ...
            <div className="relative w-full flex flex-col lg:flex-row items-stretch justify-end">
              ...
              <div className="relative w-full lg:w-[70%] xl:w-[72%] h-[300px] sm:h-[350px] lg:h-[390px] border border-[#E8E1D5] overflow-hidden bg-[#EAE6DF] shadow-sm">
                <Image
              ...
              {/* Right Vertical Column: Wine Red Panel + 18+ Years Stat Box */}
              <div className="w-full lg:w-[30%] xl:w-[28%] flex flex-row lg:flex-col justify-between mt-3 lg:mt-0 lg:border-l lg:border-[#E8E1D5]">
                ...
                <div className="w-1/2 lg:w-full bg-[#4A1118] text-[#FAF8F5] p-3.5 sm:p-4 lg:p-4 flex flex-col justify-between h-[160px] lg:h-[205px] shadow-sm">
                  <div className="text-[9px] sm:text-[9.5px] font-semibold tracking-[0.22em] text-[#E8DDD0] uppercase font-dm leading-relaxed">
                    <div>LAW</div>
                    <div>STRATEGY</div>
                    <div>JUSTICE</div>
                  </div>
                  ...
                  <div className="my-1.5 sm:my-2">
                    <span className="block w-[1px] h-5 sm:h-6 bg-[#B88E44]/70" />
                  </div>

                  <p className="font-editorial italic text-xs sm:text-[12.5px] text-[#F0E6D9] leading-tight">
                    For a<br />
                    Stronger<br />
                    Tomorrow
                  </p>
                ...
                <div className="w-1/2 lg:w-full bg-[#FAF8F5] p-3.5 sm:p-4 lg:p-4 flex flex-col justify-end h-[140px] lg:h-[185px] border-l lg:border-l-0 border-[#E8E1D5]">
                  <div className="font-heading text-3xl sm:text-4xl lg:text-[44px] text-[#6B635B] font-light leading-none">
                    18+
                  </div>
                  <div className="mt-1.5 text-[8.5px] sm:text-[9.5px] font-semibold tracking-[0.22em] text-[#78716A] uppercase font-dm leading-tight">
                    <div>YEARS OF</div>
                    <div>PRACTICE</div>
                  </div>
                  <span className="w-6 h-[1.5px] bg-[#B88E44] mt-2.5" />
                </div>
              </div>

              {/* Floating Overlapping Card: Stack of Law Books on Mahogany Desk (Positioned at bottom with zero collision) */}
              <div className="lg:absolute lg:left-[-6%] xl:left-[-8%] lg:bottom-1 z-20 w-full sm:w-[260px] lg:w-[240px] xl:w-[270px] mt-4 lg:mt-0">
                <div className="relative flex items-stretch shadow-xl bg-[#FAF8F5]">
                  {/* Left Gold Accent Tab */}
                  <div className="w-2 sm:w-2.5 bg-[#B88E44] flex-shrink-0" />

                  {/* Law Books Photographic Frame */}
                  <div className="relative aspect-[16/10] w-full overflow-hidden border border-[#2B2724]/25 bg-[#241716]">
                    <Image
            ...
            <div className="lg:hidden mt-4 pt-3 border-t border-[#E8E1D5] flex flex-wrap items-center justify-between gap-2 text-[8.5px] sm:text-[9.5px] font-semibold tracking-[0.2em] text-[#78716A] uppercase font-dm">
              <span>JUSTICE</span>
      ...
      <div className="w-full border-t border-[#E8E1D5] bg-[#FAF8F5]">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16 py-3 sm:py-3.5 flex flex-col sm:flex-row items-center justify-between gap-2 text-center sm:text-left">
          <div className="text-[9.5px] sm:text-[10.5px] font-medium tracking-[0.26em] text-[#8C847B] uppercase font-dm">
            PEOPLE &nbsp;|&nbsp; PERSPECTIVE &nbsp;|&nbsp; PROGRESS
          </div>
          <div className="text-[9.5px] sm:text-[10.5px] font-semibold tracking-[0.22em] text-[#78716A] uppercase font-dm">
